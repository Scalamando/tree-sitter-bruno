...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_headers] = STATE(2),
    [sym_auths] = STATE(2),
    [sym_authawsv4] = STATE(29),
    [sym_authbasic] = STATE(29),
    [sym_authbearer] = STATE(29),
    [sym_authdigest] = STATE(29),
    [sym_bodies] = STATE(2),
    [sym_bodyforms] = STATE(30),
    [sym_body] = STATE(30),
    [sym_bodyjson] = STATE(30),
    [sym_bodytext] = STATE(30),
    [sym_bodyxml] = STATE(30),
    [sym_bodysparql] = STATE(30),
    [sym_bodygraphql] = STATE(30),
    [sym_bodygraphqlvars] = STATE(30),
    [sym_bodyformurlencoded] = STATE(31),
    [sym_bodyformmultipart] = STATE(31),
    [sym_varsandassert] = STATE(2),
    [sym_vars] = STATE(32),
    [sym_vars_secret] = STATE(32),
    [sym_varsreq] = STATE(32),
    [sym_varsres] = STATE(32),
    [sym_assert] = STATE(32),
    [sym_script] = STATE(2),
    [sym_scriptreq] = STATE(33),
    [sym_scriptres] = STATE(33),
    [sym_tests] = STATE(2),
    [sym_docs] = STATE(2),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [72] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(65),
  [75] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(63),
  [78] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(56),
  [81] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(66),
  [84] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(70),
  [87] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(76),
  [90] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(78),
  [93] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(81),
  [96] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(80),
  ...
  [105] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(77),
  [108] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(75),
  [111] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(74),
  [114] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(73),
  [117] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(54),
  [120] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(71),
  [123] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(69),
  [126] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(68),
  [129] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(67),
  [132] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(64),
  [135] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(53),
  [138] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(57),
  [141] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(62),
  [144] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_http, 2),
  [146] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_http, 2),
  [148] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_docs, 2),
  [150] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_docs, 2),
  [152] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_vars, 2),
  [154] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_vars, 2),
  ...
  [160] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bodyformmultipart, 2),
  [162] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_bodyformmultipart, 2),
  ...
  [172] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bodyformurlencoded, 2),
  [174] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_bodyformurlencoded, 2),
  [176] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dictionary, 3),
  [178] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_dictionary, 3),
  [180] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bodyxml, 2),
  [182] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_bodyxml, 2),
  [184] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bodygraphqlvars, 2),
  [186] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_bodygraphqlvars, 2),
  [188] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assert_dictionary, 2),
  [190] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_assert_dictionary, 2),
  [192] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bodygraphql, 2),
  [194] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_bodygraphql, 2),
  [196] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bodysparql, 2),
  [198] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_bodysparql, 2),
  [200] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array, 2),
  [202] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_array, 2),
  [204] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_textblock, 2),
  [206] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_textblock, 2),
  [208] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_vars_secret, 2),
  [210] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_vars_secret, 2),
  [212] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bodytext, 2),
  [214] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_bodytext, 2),
  [216] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dictionary, 2),
  [218] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_dictionary, 2),
  [220] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_body, 2),
  [222] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_body, 2),
  [224] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tests, 2),
  [226] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_tests, 2),
  [228] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_scriptres, 2),
  [230] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_scriptres, 2),
  [232] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bodyjson, 2),
  [234] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_bodyjson, 2),
  [236] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_scriptreq, 2),
  [238] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_scriptreq, 2),
  [240] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assert, 2),
  [242] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_assert, 2),
  [244] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_auths, 1),
  [246] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_auths, 1),
  [248] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bodies, 1),
  [250] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_bodies, 1),
  [252] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bodyforms, 1),
  [254] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_bodyforms, 1),
  [256] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_varsandassert, 1),
  [258] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_varsandassert, 1),
  [260] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_script, 1),
  [262] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_script, 1),
  [264] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_varsres, 2),
  [266] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_varsres, 2),
  [268] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_meta, 2),
  [270] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_meta, 2),
  [272] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_query, 2),
  [274] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_query, 2),
  [276] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_headers, 2),
  [278] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_headers, 2),
  [280] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_authawsv4, 2),
  [282] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_authawsv4, 2),
  [284] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_authbasic, 2),
  [286] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_authbasic, 2),
  [288] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_authbearer, 2),
  [290] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_authbearer, 2),
  [292] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_authdigest, 2),
  [294] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_authdigest, 2),
  [296] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_varsreq, 2),
  [298] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_varsreq, 2),
  ...
  [308] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_assert_dictionary_repeat1, 2),
  [310] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_assert_dictionary_repeat1, 2), SHIFT_REPEAT(84),
  [313] = {.entry = {.count = 1, .reusable = false}}, SHIFT(12),
  [315] = {.entry = {.count = 1, .reusable = false}}, SHIFT(7),
  [317] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_dictionary_repeat1, 2),
  [319] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_dictionary_repeat1, 2), SHIFT_REPEAT(89),
  [322] = {.entry = {.count = 1, .reusable = true}}, SHIFT(18),
  [324] = {.entry = {.count = 1, .reusable = true}}, SHIFT(50),
  [326] = {.entry = {.count = 1, .reusable = true}}, SHIFT(82),
  [328] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_array_repeat1, 1),
  [330] = {.entry = {.count = 1, .reusable = true}}, SHIFT(9),
  [332] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_array_repeat1, 2),
  [334] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_array_repeat1, 2), SHIFT_REPEAT(50),
  [337] = {.entry = {.count = 1, .reusable = true}}, SHIFT(58),
  [339] = {.entry = {.count = 1, .reusable = true}}, SHIFT(44),
  [341] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_assert_dictionary_pair, 3),
  [343] = {.entry = {.count = 1, .reusable = true}}, SHIFT(19),
  [345] = {.entry = {.count = 1, .reusable = true}}, SHIFT(86),
  [347] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_dictionary_pair, 3),
  ...
  [361] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_http_verb, 1),
